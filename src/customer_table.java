...
public class customer_table extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        t1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tag ID", "Name", "Cintact Number", "Entry Date", "Adult Count", "Child Count", "Cost"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                String DOB = rs.getString("Contact_no");
                String bg=rs.getString("Entry_date");
                String contact=rs.getString("Adult_count");
                String DOJ=rs.getString("Child_Count");
                String Designation=rs.getString("Cost");
                model.addRow (new Object[] {id,name,DOB,bg,contact,DOJ,Designation});
            }
